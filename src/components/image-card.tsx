...
export default function ImageCard({image}: ImageCardProps) {
    return (
        <div className="image-card cursor-pointer mb-2 break-inside-avoid relative group">
            <Image
            ...
            <div className="absolute z-10 hidden group-hover:flex group-hover:visible flex-wrap gap-y-3 items-center justify-between bottom-3 left-3 right-3">
